...
AI深度编报 (nexus-report-system) — a Vue 3 SPA for AI-powered report generation. Connects to an "OpenClaw" backend to generate four types of intelligence/analysis reports: K报, HB报, 人物报, 风险报. Reports are generated via job queue with SSE real-time updates, viewable in-app, exportable to Word/PDF.
